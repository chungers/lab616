...
public class TWSEventCSVLogger extends AbstractEventWatcher 
  ...
  static {
    Varzs.export(TWSEventCSVLogger.class);
  }

  static Logger logger = Logger.getLogger(TWSEventCSVLogger.class);
  ...
  public TWSEventCSVLogger(String dir, String rootName, String clientSourceId) {
    this.dir = dir;
  ...
  public boolean isReady(long... timeout) {
    try {
      return super.isReady(timeout) && !getOutput().checkError();
    } catch (IOException e) {
      return false;
    }
  }
  ...
  public File getResource() {
    return new File(getFileName(new DateTime().withMillisOfDay(0)));
  }
  /**
   * Stop this writer.
   */
