...
TEST(SignalsPrototype, TestThreadLocal)
{
...
TEST(SignalsPrototype, PrototypeSignals)
{
  BidAsk bid_ask;
...
TEST(SignalsPrototype, PrototypeFiltering)
{
  BidAsk bid_ask;
  bid_ask.set_time_stamp(100000);
  bid_ask.set_id(1);
...
TEST(SignalsPrototype, PrototypeBindFunction)
{
...
TEST(SignalsPrototype, PrototypeMatchById)
{
  BidAsk bid_ask;
  bid_ask.set_time_stamp(100000);
  bid_ask.mutable_bid()->set_price(100.);
