...
class TestConflictingSymbolNames_Data1 : public ::google::protobuf::Message {
 public:
  ...
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >& data() const;
...
class TestConflictingSymbolNames_Data4 : public ::google::protobuf::Message {
 public:
  ...
  inline void clear_data();
  static const int kDataFieldNumber = 1;
  inline const ::google::protobuf::RepeatedPtrField< ::protobuf_unittest::TestConflictingSymbolNames_Data4 >& data() const;
  inline ::google::protobuf::RepeatedPtrField< ::protobuf_unittest::TestConflictingSymbolNames_Data4 >* mutable_data();
