...
public class ListDomainsResponse {
    ...
    @XmlElement(name = "ListDomainsResult", required = true)
     ...
     * 
     */
    public ListDomainsResponse(final ListDomainsResult listDomainsResult, final ResponseMetadata responseMetadata) {
        this.listDomainsResult = listDomainsResult;
    ...
    public boolean isSetListDomainsResult() {
        return (this.listDomainsResult!= null);
    }
     ...
     *     this instance
     */
    public ListDomainsResponse withListDomainsResult(ListDomainsResult value) {
        setListDomainsResult(value);
        return this;
    }
     ...
     *     this instance
     */
    public ListDomainsResponse withResponseMetadata(ResponseMetadata value) {
    ...
    public String toXML() {
        ...
        xml.append("<ListDomainsResponse xmlns=\"http://sdb.amazonaws.com/doc/2009-04-15/\">");
        if (isSetListDomainsResult()) {
            ListDomainsResult  listDomainsResult = getListDomainsResult();
    ...
    public String toJSON() {
        ...
        json.append("{\"ListDomainsResponse\" : {");
        ...
        if (isSetListDomainsResult()) {
            ...
            json.append("\"ListDomainsResult\" : {");
            ListDomainsResult  listDomainsResult = getListDomainsResult();

            json.append(listDomainsResult.toJSONFragment());
            json.append("}");
            first = false;
        } 
        if (isSetResponseMetadata()) {
