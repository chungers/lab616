...
public class SelectRequest {
    ...
    @XmlElement(name = "SelectExpression")
     ...
     * 
     */
    public SelectRequest(final String selectExpression, final String nextToken) {
     ...
     *     this instance
     */
    public SelectRequest withSelectExpression(String value) {
     ...
     *     this instance
     */
    public SelectRequest withNextToken(String value) {
        setNextToken(value);
        return this;
    }
    ...
    protected String toJSONFragment() {
        ...
        boolean first = true;
        if (isSetSelectExpression()) {
            if (!first) json.append(", ");
            json.append(quoteJSON("SelectExpression"));
            json.append(" : ");
            json.append(quoteJSON(getSelectExpression()));
            first = false;
        }
        if (isSetNextToken()) {
            if (!first) json.append(", ");
