 ...
 *
 */
public class DeleteAttributesSample {
     ...
     */
    public static void invokeDeleteAttributes(AmazonSimpleDB service, DeleteAttributesRequest request) {
        try {
            
            DeleteAttributesResponse response = service.deleteAttributes(request);

            
            System.out.println ("DeleteAttributes Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.println("    DeleteAttributesResponse");
            System.out.println();
