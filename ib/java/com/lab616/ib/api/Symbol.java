...
public abstract class Symbol implements Cloneable {
  ...
  Symbol(int tid) {
    Preconditions.checkArgument(tid > 0);
    tickerId = tid;
    symbol = fromTickerId(tid);
  }
  
  Symbol(String s) {
    Preconditions.checkNotNull(s);
    Preconditions.checkArgument(s.length() <= MAX_CHARS);
    symbol = s.toUpperCase();
    tickerId = toTickerId(symbol);
  }

  /**
   * Returns a unique ticker id suitable for use in TWS API calls.
  ...
  /**
   * Returns the string representation of the ticker symbol.
   */
  @Override
  public String toString() {
    return this.symbol + "," + this.tickerId;
  }
   ...
   * @return The ticker id.
   */
  protected int toTickerId(String symbol) {
   ...
   */
  protected String fromTickerId(int tickerId) {
