...
public class BackDataDownloader extends Thread implements ErrorListener {
    ...
    public BackDataDownloader(BackDataDialog backDataDialog, Contract contract, BarSize barSize, boolean rthOnly, String fileName) {
    ...
    private void download() throws InterruptedException {
        ...
        while (cal.after(firstDate)) {
            ...
            trader.getAssistant().getHistoricalData(requestId, contract, endTime, barSize.getHistRequestDuration(), barSize.toIBText(), infoType, onlyRTHPriceBars, 2);
    ...
    private void writeDescriptior() {
        writer.println("# This dataset is generated by JSystemTrader. Data source: Interactive Brokers.");
