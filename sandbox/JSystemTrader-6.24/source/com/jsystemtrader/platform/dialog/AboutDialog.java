...
public class AboutDialog extends JDialog {
    ...
    private void init() {
        ...
        JLabel versionValueLabel = new JLabel("6.24, September 13, 2008");
        ...
        JLabel authorValueLabel = new JLabel("Eugene Kononov <nonlinear5@yahoo.com>");
        ...
        JLabel emailLabel = new JLabel("Maintainer:", JLabel.TRAILING);
        JLabel emailValueLabel = new JLabel("Florent Guiliani <florent@guiliani.fr>");
        ...
        getContentPane().setPreferredSize(new Dimension(421, 260));
