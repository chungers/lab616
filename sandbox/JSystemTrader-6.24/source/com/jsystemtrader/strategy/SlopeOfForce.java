...
/**
 * This sample strategy trades AAPL stock using the slope of Force Index
 * as an indicator. When the slope is upward, the strategy buys. Otherwise,
 * it sells short. This is a trend following system.
 */
public class SlopeOfForce extends Strategy {
    ...
    public SlopeOfForce(StrategyParams params) throws JSystemTraderException {
        // Define the contract to trade
        Contract contract = ContractFactory.makeStockContract("AAPL", "SMART", "USD");
