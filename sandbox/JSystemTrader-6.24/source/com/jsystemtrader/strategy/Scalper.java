...
/**
 * A very fast strategy that aims to capture small profits. It trades the S&P E-Mini futures
 * based on a divergence of two trends. 15-second bars are used.
 */
public class Scalper extends Strategy {
    ...
    public Scalper(StrategyParams params) throws JSystemTraderException {
        ...
        trendDivergenceInd = new TrendDivergence(quoteHistory, fastTrendLength, slowTrendLength);
