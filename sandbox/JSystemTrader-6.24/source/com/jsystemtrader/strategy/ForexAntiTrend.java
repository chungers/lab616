 ...
 * short. Otherwise, it buys. This is an anti-trend system. The moving averages
 * are calculated from the priceBar history of the 5-minute bars.
 */
public class ForexAntiTrend extends Strategy {
    ...
    public ForexAntiTrend(StrategyParams params) throws JSystemTraderException {
        ...
        slowTrendLength = (int) params.get(SLOW_TREND_LENGTH, 32);
