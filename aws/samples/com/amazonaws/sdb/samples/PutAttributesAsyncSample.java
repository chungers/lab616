...
/**
 *
 * Put Attributes  Samples
 *
 *
 */
public class PutAttributesAsyncSample {

    /**
     * Just add few required parameters, and try the service
     * Put Attributes functionality
     *
     * @param args unused
     */
    public static void main(String... args) {
         ...
         * requests to process.
         ***********************************************************************/
         PutAttributesRequest requestOne = new PutAttributesRequest();
         // @TODO: set request parameters here

         PutAttributesRequest requestTwo = new PutAttributesRequest();
         // @TODO: set second request parameters here

         List<PutAttributesRequest> requests = new ArrayList<PutAttributesRequest>();
         requests.add(requestOne);
         requests.add(requestTwo);

         invokePutAttributes(service, requests);
     ...
     */
    public static void invokePutAttributes(AmazonSimpleDBAsync service, List<PutAttributesRequest> requests) {
        List<Future<PutAttributesResponse>> responses = new ArrayList<Future<PutAttributesResponse>>();
        for (PutAttributesRequest request : requests) {
            responses.add(service.putAttributesAsync(request));
        }
        for (Future<PutAttributesResponse> future : responses) {
            while (!future.isDone()) {
                Thread.yield();
            }
            try {
                PutAttributesResponse response = future.get();
                // Original request corresponding to this response, if needed:
                PutAttributesRequest originalRequest = requests.get(responses.indexOf(future));
