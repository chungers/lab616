 ...
 *
 */
public class PutAttributesSample {
     ...
     */
    public static void invokePutAttributes(AmazonSimpleDB service, PutAttributesRequest request) {
        try {
            
            PutAttributesResponse response = service.putAttributes(request);

            
            System.out.println ("PutAttributes Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.println("    PutAttributesResponse");
            System.out.println();
