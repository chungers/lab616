 ...
 *
 */
public class CreateDomainSample {
     ...
     */
    public static void invokeCreateDomain(AmazonSimpleDB service, CreateDomainRequest request) {
        try {
            
            CreateDomainResponse response = service.createDomain(request);

            
            System.out.println ("CreateDomain Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.println("    CreateDomainResponse");
            System.out.println();
